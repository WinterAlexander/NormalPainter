...
import com.normalpainter.render.lighting.OrientedShadedTrio;
...
public class OrientedShadedTrioProvider implements AssetProvider<OrientedShadedTrio>
{
	...
	{
		Validation.ensureNotNull(shadedTrioProvider, "shadedTrioProvider");
		Validation.ensureNotNull(extraPreshadeds, "extraPreshadeds");

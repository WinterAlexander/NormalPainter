...
import net.jumpai.render.AbstractSpriteBatch;
import net.jumpai.render.UVTransform;
import net.jumpai.world.lightmap.LightMaskGenerator;
...
public class LightingBatchImpl extends AbstractSpriteBatch implements LightingBatch
{
	                         ...
	                         boolean lightColor)
	{
		...
		ensureNotNull(lightMaskGenerator, "lightMaskGenerator");

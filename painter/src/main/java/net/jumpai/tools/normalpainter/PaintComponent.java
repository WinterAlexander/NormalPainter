...
import net.jumpai.tools.normalpainter.buffer.PixmapBuffer;
import net.jumpai.tools.normalpainter.buffer.RangedGdxBuffer;
...
import static net.jumpai.tools.normalpainter.NormalPainterScreen.WORLD_PERFECT_SCALE;

...
import net.jumpai.render.Assets;
import net.jumpai.render.lighting.LightRenderMode;
import net.jumpai.render.lighting.LightingBatchImpl;
import net.jumpai.tools.normalpainter.NormalPainterApp;
import net.jumpai.tools.normalpainter.StageStackedScreen;
import net.jumpai.util.gdx.GdxUtil;
import net.jumpai.util.log.NullLogger;
...
import net.jumpai.util.ui.skin.BetterSkinLoader.SkinParam;
import net.jumpai.world.World;
import net.jumpai.world.camera.GameCameraImpl;
import net.jumpai.world.component.light.FireLightSource;
import net.jumpai.world.component.light.LavaLightSource;
import net.jumpai.world.component.light.LightEmitter;
import net.jumpai.world.component.light.LightEmitterComponent;
import net.jumpai.world.component.light.LightSource;
import net.jumpai.world.component.location.LocationComponent;
import net.jumpai.world.component.render.RenderPriority;
import net.jumpai.world.lightmap.FBOLightMapPageRenderer;
import net.jumpai.world.lightmap.FBOLightMaskGenerator;
import net.jumpai.world.lightmap.LightMap;
import net.jumpai.world.lightmap.LightMapPage;
...
import static net.jumpai.util.gdx.Scene2dUtil.invalidateRecursively;
import static net.jumpai.util.math.NumberUtil.tryParseFloat;
/**
...
public class LightTesterScreen extends InputAdapter implements StageStackedScreen
{
	...
	public void create()
	{
		...
		camera = new GameCameraImpl(false);
		...
		stage = new DynamicStage(new FitViewport(STAGE_WIDTH, STAGE_HEIGHT), batch);
	...
	public void render(float delta)
	{
		...
		float width = texture.getRegionWidth() * WORLD_PERFECT_SCALE;
		float height = texture.getRegionHeight() * WORLD_PERFECT_SCALE;
